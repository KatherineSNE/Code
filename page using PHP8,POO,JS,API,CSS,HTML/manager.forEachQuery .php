...
//** I USE A FOREACH LOOP TO USE THE ORDER OF THE PREVIOUS FOREACH IN THE ONE FOLLOWING. THIS IS TO ALLOW
//** A LIST OF INGREDIENTS SHOWN BELOW A PARAGRAH TO APPEAR IN THE SAME ORDER AS THEY DO IN THE PARAGRAPH;
//**  $item STOCKS THE RESULT OF THE FIRST REQUEST WHICH GIVES THE ORDER REQUIRED
//** I THEN GIVE THE LIST ITEMS AN ALIAS  USING AS SO I CAN ACCESS
//** THEM INDIVIDUALLY WHEN CONSTRUNCTING THE FRONT USING AN API JSON AND JS/
//** I STOCK THE TYPE IN A VARIABLE ALLOWING THE FACTORISATION OF THE FUNCTION FOR FUTURE USE 
//** THE VARIABLE IS STOCKED IN THE API */
